...
# ============== Report Agent Dialogue Interfaces ==============
...
def chat_with_report_agent():
    ...
    Report Agent can autonomously call retrieval tools to answer questions in the dialogue
...
# ============== Report Progress and Sections Interfaces ==============
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this interface to get generated section content without waiting for the whole report
...
def check_report_status(simulation_id: str):
    ...
    Used by frontend to determine whether to unlock Interview function
...
def get_agent_log(report_id: str):
    ...
    Real-time acquisition of every step in the report generation process, including:
    - Report start, planning start/completion
    - Start of each section, tool calls, LLM response, completion
...
def stream_agent_log(report_id: str):
    """
    Get full Agent logs (get all at once)
...
def stream_console_log(report_id: str):
    """
    Get full console logs (get all at once)
