...
Reads nodes from Zep graph and filters nodes that match predefined entity types
"""
...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            func: Function to execute (lambda or callable with no arguments)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If the node has only one label "Entity", it means it doesn't match our predefined types, so skip
        - If the labels contain tags other than "Entity" and "Node", it matches a predefined type, so keep
        ...
        for node in all_nodes:
            ...
            if enrich_with_edges:
                ...
                # Get basic info for associated nodes
                related_nodes = []
