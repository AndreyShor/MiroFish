...
Interface 2: Using Zep API to build Standalone Graph
"""
...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        # Execute construction in a background thread
    ...
    def _build_graph_worker(
        ...
        try:
            ...
            self.task_manager.update_task(
                task_id,
                progress=20,
                message=f"Text divided into {total_chunks} chunks"
            )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is usage required by Zep SDK; warning is from dynamic class creation and can be safely ignored
    ...
    def _wait_for_episodes(
        ...
        if progress_callback:
            progress_callback(f"Starting to wait for {total_episodes} chunks to be processed...", 0)
        ...
        while pending_episodes:
            ...
            if pending_episodes:
                time.sleep(3)  # Check once every 3 seconds
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        # Create node map to get node names
        node_map = {}
        for node in nodes:
