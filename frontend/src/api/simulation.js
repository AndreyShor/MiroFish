...
/**
 * Get Agent Profiles in progress in real-time
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Get simulation configuration in progress in real-time
 * @param {string} simulationId
...
/**
 * Get simulation run detailed status (contains recent actions)
 * @param {string} simulationId
 */
