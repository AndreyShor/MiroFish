...
Process-to-process communication between Flask backend and simulation scripts

Implements a simple command/response pattern via the filesystem:
1. Flask writes command to commands/ directory
2. Simulation script polls command directory, executes command and writes response to responses/ directory
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: interview both platforms (if dual) or the available platform
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each item's platform)
                ...
                - None: Default to both platforms for each Agent
            timeout: Timeout
