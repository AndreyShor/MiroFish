...
Manages parallel simulations on Twitter and Reddit
Uses preset scripts + LLM for intelligent configuration generation
"""
...
class SimulationManager:
    ...
    3. Use LLM for intelligent generation of simulation configuration parameters
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation config parameters (time, activity, speaking frequency, etc.)
        4. Save config file and Profile files
        ...
        try:
            ...
            # Pass graph_id to enable Zep retrieval feature for richer context
            ...
            # Set real-time saving file path (prefer Reddit JSON format)
            ...
            # Reddit profiles are saved in real-time during generation, save once more here for integrity
            if progress_callback:
                progress_callback(
            ...
            # When simulation starts, simulation_runner will run the script from the scripts/ directory
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f"   - Run parallel dual-platform: python {scripts_dir}/run_parallel_simulation.py --config {config_path}"
            )
        }
